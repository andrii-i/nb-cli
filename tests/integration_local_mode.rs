...
fn test_create_with_force_overwrites() {
    ...
    let result = env
        .run(&["notebook", "create", nb_path.to_str().unwrap(), "--force"])
        .assert_success();
...
fn test_read_specific_cell_by_index() {
    ...
    let result = env
        .run(&["notebook", "read", nb_path.to_str().unwrap(), "--cell", "1"])
        .assert_success();
...
fn test_read_only_code() {
    ...
    let result = env
        .run(&["notebook", "read", nb_path.to_str().unwrap(), "--only-code"])
        .assert_success();
...
fn test_read_text_format() {
    ...
    let result = env
        .run(&["notebook", "read", nb_path.to_str().unwrap(), "-f", "text"])
        .assert_success();
...
fn test_delete_cell_by_index() {
    ...
    let result = env
        .run(&["cell", "delete", nb_path.to_str().unwrap(), "--cell", "0"])
        .assert_success();
...
fn test_delete_with_negative_index() {
    ...
    let result = env
        .run(&["cell", "delete", nb_path.to_str().unwrap(), "--cell=-1"])
        .assert_success();
...
fn test_search_finds_pattern() {
    ...
    let result = env
        .run(&["notebook", "search", nb_path.to_str().unwrap(), "import"])
        .assert_success();
...
fn test_clear_outputs_specific_cell() {
    ...
    let result = env
        .run(&["output", "clear", nb_path.to_str().unwrap(), "--cell", "0"])
        .assert_success();
...
fn test_workflow_modify_and_verify() {
    ...
    // Delete second cell
    env.run(&["cell", "delete", nb_path.to_str().unwrap(), "--cell", "1"])
        .assert_success();
